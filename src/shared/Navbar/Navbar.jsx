...
const Navbar = () => {
    ...
    const options = [
        { value: '', text: '--Choose an Mode--' },
        { value: '#000', text: 'Dark' },
        { value: '#eedd82', text: 'Light' },
    ];
    ...
    const menuItems = <>
        ...
        {user &&
            <li> <NavLink className={({ isActive }) => isActive ? "text-white transition hover:bg-transparent text-lg font-semibold" : "text-lg font-semibold hover:text-white transition hover:bg-transparent"} to="/dashboard">Dashboard</NavLink> </li>
        }
                ...
                <div className="navbar">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-[#5ab337d6] z-50 opacity-100 rounded-box w-52">
                                {menuItems}
                            </ul>
                        </div>
